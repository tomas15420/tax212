...
public record PortfolioStatusItemDto(
        ...
        @Schema(description = "Množství, které již splnilo časový test a je osvobozeno od daně (k danému datu)", example = "4.20")
        BigDecimal taxFreeQuantity,

        @Schema(description = "Množství, které je stále v daňovém testu (k danému datu)", example = "6.35")
        ...
        @Schema(description = "Skutečný realizovaný zisk nebo ztráta z prodejů (očištěno od FX poplatku)")
        BigDecimal actualRealisedGainLoss,

        @Schema(description = "Rozdíl mezi průměrným prodejem a nákupem (v %)")
        BigDecimal realizedGainLossPercent,

        @Schema(description = "Skutečný rozdíl mezi průměrným prodejem a nákupem (v %), očištěno od FX poplatku")
        BigDecimal actualRealizedGainLossPercent,
